package turqut.MobileGamesLibraryFirstApp;

import turqut.MobileGamesLibraryFirstApp.model.Game;
import turqut.MobileGamesLibraryFirstApp.model.GameCategory;
import turqut.MobileGamesLibraryFirstApp.service.impl.MobileGamesLibraryImpl;
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    if (foundGame != null) {
                        System.out.println("Game found: " + foundGame);
                    } else {
                        System.out.println("Game not found in this category.");
                    }
                    break;
